...
import { ArrowRight, ChevronDown, Zap, Droplets, Sun, Sprout } from "lucide-react";
...
export function HomeHero({ cms }: { cms?: CmsHero | null }) {
  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-center overflow-hidden bg-background">
      ...
      <motion.div
        ...
        className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-1.5 text-foreground-subtle cursor-pointer"
